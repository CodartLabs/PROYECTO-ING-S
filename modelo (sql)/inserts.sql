...
---------------------------------------*/
/*INSERTANDO HOMBRES*/
INSERT INTO usuarios (username, password, nombres, apellidos, nacimiento, direccion, sobre_mi,foto) VALUES('turpis','FER29RYT3YU','Connor','Mccormick','1996/4/2','Ap #409-5414 Egestas. Ave',null, '1.jpg');
INSERT INTO usuarios (username, password, nombres, apellidos, nacimiento, direccion, sobre_mi,foto) VALUES('semper','NBV83JPY5QL','Daniel','Weber','1998/12/11','424-3298 Nulla St.',null, '2.jpg');
INSERT INTO usuarios (username, password, nombres, apellidos, nacimiento, direccion, sobre_mi,foto) VALUES('elementum','VAG92MRH5TP','Gannon','Mcdonald','1999/6/13','Ap #855-3849 Non, Av.',null, '3.jpg');
INSERT INTO usuarios (username, password, nombres, apellidos, nacimiento, direccion, sobre_mi,foto) VALUES('Morbi','PPL45YDM7IN','Zahir','Bridges','2003/1/12','P.O. Box 134, 1288 Interdum St.',null, '4.jpg');
INSERT INTO usuarios (username, password, nombres, apellidos, nacimiento, direccion, sobre_mi,foto) VALUES('erat','NXX15PFJ5ON','Judah','Donaldson','1993/3/9','215-9927 Cursus. Av.',null, '5.jpg');
INSERT INTO usuarios (username, password, nombres, apellidos, nacimiento, direccion, sobre_mi,foto) VALUES('pede','ISX65NFW6FQ','Kenneth','Ochoa','2001/10/16','P.O. Box 535, 3108 Ac St.',null, '6.jpg');
INSERT INTO usuarios (username, password, nombres, apellidos, nacimiento, direccion, sobre_mi,foto) VALUES('Pellentesque','FKG48VSR8TR','Thane','Meyers','1994/11/6','Ap #280-6188 Gravida. Avenue',null, '7.jpg');
INSERT INTO usuarios (username, password, nombres, apellidos, nacimiento, direccion, sobre_mi,foto) VALUES('elyisus','yisusmorales','Jesus','Morales Huaman','2001/11/18','940-8836 Aenean Street',null, '8.jpg');
INSERT INTO usuarios (username, password, nombres, apellidos, nacimiento, direccion, sobre_mi,foto) VALUES('nisi','IXQ98JPM9EF','David','De Morales','1997/6/22','P.O. Box 172, 146 Nullam Road',null, '9.jpg');
INSERT INTO usuarios (username, password, nombres, apellidos, nacimiento, direccion, sobre_mi,foto) VALUES('libero','GOC11KLA7VB','Fitzgerald','Schneider','1993/3/7','Ap #535-1667 Libero. Ave',null, '10.jpg');
/*INSERTANDO MUJERES*/
INSERT INTO usuarios (username, password, nombres, apellidos, nacimiento, direccion, sobre_mi,foto) VALUES('vel','DRW62OIU6YL','Jocelyn','Patterson','1999-08-20','291-1837 Odio Ave',null, '11.jpg');
INSERT INTO usuarios (username, password, nombres, apellidos, nacimiento, direccion, sobre_mi,foto) VALUES('mauris','YYC47UCL0AQ','Taylor','Mcdonald','1999-04-11','520-6174 Ridiculus Avenue',null, '12.jpg');
INSERT INTO usuarios (username, password, nombres, apellidos, nacimiento, direccion, sobre_mi,foto) VALUES('purus','PGW46EDV7JG','Ava','Burks','1998-12-01','P.O. Box 803, 9159 Blandit Road',null, '13.jpg');
INSERT INTO usuarios (username, password, nombres, apellidos, nacimiento, direccion, sobre_mi,foto) VALUES('sit','WZI22MBQ3VG','Victoria','Giles','1998-07-23','498-4026 Curae; Street',null, '14.jpg');
INSERT INTO usuarios (username, password, nombres, apellidos, nacimiento, direccion, sobre_mi,foto) VALUES('May','GVU17QVF9VE','May','Conrad','1998-03-14','Ap #946-8253 Montes, Av.',null, '15.jpg');
INSERT INTO usuarios (username, password, nombres, apellidos, nacimiento, direccion, sobre_mi,foto) VALUES('Leslie','RWK60ILK8QC','Leslie','Mullen','1997-11-03','918 Eget Road',null, '16.jpg');
INSERT INTO usuarios (username, password, nombres, apellidos, nacimiento, direccion, sobre_mi,foto) VALUES('eget','QZB52XLN0ND','Xandra','Bean','1997-06-25','Ap #196-9742 Torquent Street',null, '17.jpg');
INSERT INTO usuarios (username, password, nombres, apellidos, nacimiento, direccion, sobre_mi,foto) VALUES('Alexandra','KWO54FWJ9XN','Alexandra','Best','1997-02-14','Ap #200-6839 At Road',null, '18.jpg');
INSERT INTO usuarios (username, password, nombres, apellidos, nacimiento, direccion, sobre_mi,foto) VALUES('Aileen','QNL84LGA9FB','Aileen','Schneider','1996-10-06','938-2790 Ultrices St.',null, '19.jpg');
INSERT INTO usuarios (username, password, nombres, apellidos, nacimiento, direccion, sobre_mi,foto) VALUES('carrol','SRB18ILN6SA','Kyla','Carroll','1996-05-28','P.O. Box 590, 1309 Lobortis Rd.',null, '20.jpg');
/*INSERTANDO PROFESOR*/
...
INSERT INTO blogs (id_usuario, fecha_blog, nombre_blog, contenido) VALUES(13,'2021/8/10','La NASA','La Administración Nacional de Aeronáutica y el Espacio, más conocida como NASA, es la agencia del gobierno estadounidense responsable del programa espacial civil, así como de la investigación aeronáutica y aeroespacial.');
